...
window.INISCH_TESTIMONIOS = [
  ...
  /* --- Taller Intensivo --- */
  { nombre: "Adilene", video: "https://youtu.be/n6Nzkwe0DgM",
    texto: "Encontré la última pieza del rompecabezas para entender la vida.",
    programa: 1, lang: "es" },
  { nombre: "Adriana", video: "https://youtu.be/5m9Yo3IKd8I",
    texto: "Siento que mi conciencia se expande hacia el amor infinito.",
    programa: 1, lang: "es" },
  { nombre: "Alejandro", video: "https://youtu.be/lxW95brnXYw",
    texto: "Ha sido la mayor inversión de mi vida, y la abrazo con todo mi corazón.",
    programa: 1, lang: "es" },
  { nombre: "Aurora", video: "https://youtu.be/3S1s2uewuGk",
    texto: "El Sistema Código Holográfico cambió mi vida.",
    programa: 1, lang: "es" },
  { nombre: "Debs", video: "https://youtu.be/JzIXsmDt6cg",
    texto: "Se siente como un gran regalo. Me siento afortunada de poder aprender tanto.",
    programa: 1, lang: "es" },
  { nombre: "Ema", video: "https://youtu.be/EEX8EgkSL3E",
    texto: "Después de estudiar muchísimas técnicas holísticas, sé que este fue el camino necesario para llegar hasta aquí.",
    programa: 1, lang: "es" },
  { nombre: "Haulima", video: "https://youtu.be/7ZM18rsOEe4",
    texto: "Pude integrar todo lo que yo quería saber.",
    programa: 1, lang: "es" },
  { nombre: "Isac", video: "https://youtu.be/z7UFYQ5WtmM",
    texto: "Podemos ver desde dónde fueron plantadas las ideas que nos hacen sufrir.",
    programa: 1, lang: "es" },
  { nombre: "Jaime", video: "https://youtu.be/flWN9Jh_CTI",
    texto: "Es un camino que me ayuda a acercarme más a la verdad.",
    programa: 1, lang: "es" },
  { nombre: "Mariana", video: "https://youtu.be/CvpTAqSff9w",
    texto: "¡Después de esto, no sé qué más puedo aprender!",
    programa: 1, lang: "es" },
  { nombre: "Melba", video: "https://youtu.be/A2QQPN88BhI",
    texto: "Esta serenidad que ha llegado a mi vida no la cambio por nada.",
    programa: 1, lang: "es" },
  { nombre: "Mundo", video: "https://youtu.be/-0EydBHUxco",
    texto: "Me llevo un conocimiento realmente único. Considero que es la última enseñanza.",
    programa: 1, lang: "es" },
  { nombre: "Norma", video: "https://youtu.be/lTYHD8RzeJE",
    texto: "La conciencia se hace presente en su más hermosa pureza; la esencia del amor abunda.",
    programa: 1, lang: "es" },

  /* --- Diplomado de Especialista --- */
  { nombre: "Aurora", video: "https://youtu.be/adDGuazRgAg",
    texto: "Se sintió como saborear el postre.",
    programa: 2, lang: "es" },
  { nombre: "Blanca", video: "https://youtu.be/tCMRjQ7b8zc",
    texto: "Llegó a decirme: «Yo te voy a mostrar lo que es la felicidad».",
    programa: 2, lang: "es" },
  { nombre: "José Miguel", video: "https://youtu.be/XyAizBFjW8s",
    texto: "Nunca me había hecho tanto sentido la frase «soy el prójimo».",
    programa: 2, lang: "es" },
  { nombre: "Livier", video: "https://youtu.be/53ivUzQBTFc",
    texto: "Cuando el alumno está listo, el maestro aparece. Todo se alineó para encontrar esa pieza que nos faltaba.",
    programa: 2, lang: "es" },
  { nombre: "Lupita", video: "https://youtu.be/RksajDLI9ig",
    texto: "De todos mis compañeros aprendí algo, porque ellos también son un reflejo de mí.",
    programa: 2, lang: "es" },
  { nombre: "Mariana", video: "https://youtu.be/MB6OX6ZrOtg",
    texto: "La información está muy bien estructurada y te da claridad sobre lo que estás aprendiendo.",
    programa: 2, lang: "es" },
  { nombre: "Maye", video: "https://youtu.be/FDRTd0Hx2RQ",
    texto: "Se ha integrado en mí esa parte del conocimiento y de la espiritualidad, desde una estructura con claridad.",
    programa: 2, lang: "es" },
